...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20250928073657_language_option_tables') THEN
    ALTER TABLE language_word_frequencies DROP CONSTRAINT fk_language_word_frequencies_language_translations_language_tr;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20250928073657_language_option_tables') THEN
    DROP INDEX ix_language_word_frequencies_language_translation_id;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20250928073657_language_option_tables') THEN
    ALTER TABLE language_translations ADD langauge_language_id uuid NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20250928073657_language_option_tables') THEN
    ALTER TABLE language_translations ADD CONSTRAINT fk_language_translations_languages_langauge_language_id FOREIGN KEY (langauge_language_id) REFERENCES "Languages" (language_id) ON DELETE CASCADE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20250928073657_language_option_tables') THEN
    ALTER TABLE language_word_frequencies ADD CONSTRAINT fk_language_word_frequencies_languages_language_id FOREIGN KEY (language_id) REFERENCES "Languages" (language_id) ON DELETE CASCADE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20250928073657_language_option_tables') THEN
    INSERT INTO "__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20250928073657_language_option_tables', '9.0.9');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20251005080001_securityTables') THEN
    ALTER TABLE profiles ADD email_address text NOT NULL DEFAULT '';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20251005080001_securityTables') THEN
    INSERT INTO "__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20251005080001_securityTables', '9.0.9');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20251008031202_addTemplateType') THEN
    ALTER TABLE flash_card_set_templates ADD flash_card_type integer NOT NULL DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20251008031202_addTemplateType') THEN
    INSERT INTO "__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20251008031202_addTemplateType', '9.0.9');
    END IF;
END $EF$;

DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20251021021311_jwtRefresh') THEN
    ALTER TABLE sessions ADD device_id text NOT NULL DEFAULT '';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20251021021311_jwtRefresh') THEN
    ALTER TABLE sessions ADD last_seen_at timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "migration_id" = '20251021021311_jwtRefresh') THEN
    INSERT INTO "__EFMigrationsHistory" (migration_id, product_version)
    VALUES ('20251021021311_jwtRefresh', '9.0.9');
    END IF;
END $EF$;
COMMIT;
